...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    RacePanel: {
        ...
        elements: {
            ...
            opponentIdentityCard:{ x: 0,    y: 0,   w: 280, h: 44,   type: 'sprite' },
    ...
    SettingsPanel: {
        ...
        elements: {
            ...
            deleteBtn:     { x: 0,    y: -518, w: 220, h: 32, type: 'btnGhost' },
    ...
    TokenDuelPanel: {
        ...
        elements: {
            ...
            levelPill:       { x: -100, y: 620,  w: 370, h: 72, type: 'chip' },
            solPill:         { x: 220,  y: 620,  w: 260, h: 72, type: 'chip' },
            matchSetupCard:  { x: 0,    y: 455,  w: 712, h: 124, type: 'group' },
            feedFrameCard:   { x: 0,    y: -37,  w: 712, h: 824, type: 'sprite' },
            search:          { x: 46,   y: 345,  w: 312, h: 44, type: 'editbox' },
            searchClear:     { x: 188,  y: 345,  w: 32,  h: 32, type: 'btnGhost' },
            feedTabDropdown: { x: -224, y: 345,  w: 200, h: 44, type: 'btnGhost' },
            watchlistStar:   { x: 240,  y: 345,  w: 44,  h: 44, type: 'btnGhost' },
            cancelWatchlist: { x: 240,  y: 345,  w: 36,  h: 36, type: 'btnGhost' },
            liveIndicator:   { x: 314,  y: 345,  w: 80,  h: 24, type: 'label' },
            minLiqDropdown:    { x: -16,  y: 293,  w: 110, h: 32,  type: 'chip' },
            columnsBtn:        { x: 270,  y: 293,  w: 96,  h: 32,  type: 'chip' },
            feedColumnHeaders: { x: 0,    y: 255,  w: 696, h: 24,  type: 'group' },
            feedScrollView:    { x: 0,    y: -101, w: 696, h: 680, type: 'scrollview' },
            squadPanel:        { x: 0,    y: -592, w: 700, h: 220, type: 'group' },
            squadHeaderLabel:  { x: 0,    y: -527, w: 420, h: 24,  type: 'label' },
            wagerValueButton:  { x: -240, y: -642, w: 200, h: 56,  type: 'btnGhost' },
            wagerStartButton:  { x: 110,  y: -642, w: 460, h: 56,  type: 'btnPrimary' },
            wagerLockChip:     { x: -240, y: -642, w: 200, h: 56,  type: 'chip' },
            wagerBotChip:      { x: -240, y: -642, w: 200, h: 56,  type: 'chip' },
            wagerHintLabel:    { x: 0,    y: -700, w: 600, h: 24,  type: 'label' },
            wagerDropdown:     { x: -240, y: -610, w: 360, h: 360, type: 'group' },
            ...
            status:            { x: 0,    y: -770, w: 688, h: 26,  type: 'label' },
        },
        allowedOverlaps: [
            ['BackLinkLabel', 'BackButton'],
