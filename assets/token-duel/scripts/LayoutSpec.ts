...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    TokenDuelPanel: {
        ...
        elements: {
            ...
            levelPill:       { x: 113,  y: 620,  w: 185, h: 36, type: 'chip' },
            solPill:         { x: 279,  y: 620,  w: 130, h: 36, type: 'chip' },
            matchSetupCard:  { x: 0,    y: 485,  w: 688, h: 124, type: 'group' },
            feedFrameCard:   { x: 0,    y: 167,  w: 712, h: 416, type: 'sprite' },
            ...
            feedScrollView:    { x: 0,    y: 103,  w: 696, h: 272, type: 'scrollview' },
            squadPanel:        { x: 0,    y: -184, w: 700, h: 220, type: 'group' },
            squadHeaderLabel:  { x: 0,    y: -119, w: 420, h: 24,  type: 'label' },
            wagerValueButton:  { x: -240, y: -234, w: 200, h: 56,  type: 'btnGhost' },
            wagerStartButton:  { x: 110,  y: -234, w: 460, h: 56,  type: 'btnPrimary' },
            wagerLockChip:     { x: -240, y: -234, w: 200, h: 56,  type: 'chip' },
            wagerBotChip:      { x: -240, y: -234, w: 200, h: 56,  type: 'chip' },
            wagerHintLabel:    { x: 0,    y: -700, w: 600, h: 24,  type: 'label' },
            wagerDropdown:     { x: -240, y: -202, w: 360, h: 360, type: 'group' },
            ...
            status:            { x: 0,    y: -362, w: 688, h: 26,  type: 'label' },
        },
        allowedOverlaps: [
            ['BackLinkLabel', 'BackButton'],
