...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    TokenDuelPanel: {
        ...
        elements: {
            ...
            squadPanel:        { x: 0,    y: -359, w: 700, h: 220, type: 'group' },
            squadHeaderLabel:  { x: 0,    y: -294, w: 420, h: 24,  type: 'label' },
            wagerValueButton:  { x: -240, y: -409, w: 200, h: 56,  type: 'btnGhost' },
            wagerStartButton:  { x: 110,  y: -409, w: 460, h: 56,  type: 'btnPrimary' },
            wagerLockChip:     { x: -240, y: -409, w: 200, h: 56,  type: 'chip' },
            wagerBotChip:      { x: -240, y: -409, w: 200, h: 56,  type: 'chip' },
            wagerHintLabel:    { x: 0,    y: -700, w: 600, h: 24,  type: 'label' },
            wagerDropdown:     { x: -240, y: -377, w: 360, h: 360, type: 'group' },
