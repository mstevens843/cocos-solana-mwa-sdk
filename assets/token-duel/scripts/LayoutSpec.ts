...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    FindMatchPanel: {
        ...
        elements: {
            ...
            // 2026-04-27 redesign — unified filter card + tab underline + pulse dot.
            liveCountPulseDot:  { x: -90, y: 665, w: 10,  h: 10,  type: 'sprite' },
            filterCard:         { x: 0,   y: 535, w: 700, h: 140, type: 'sprite' },
            filterDivider1:     { x: 0,   y: 558, w: 620, h: 1,   type: 'sprite' },
            filterDivider2:     { x: 0,   y: 513, w: 620, h: 1,   type: 'sprite' },
            tabActiveUnderline: { x: -122, y: 610, w: 200, h: 4,  type: 'sprite' },
