...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    TokenDuelPanel: {
        ...
        elements: {
            ...
            wagerValueButton:  { x: -240, y: -440, w: 200, h: 56,  type: 'btnGhost' },
            wagerStartButton:  { x: 110,  y: -440, w: 460, h: 56,  type: 'btnPrimary' },
            wagerLockChip:     { x: -240, y: -440, w: 200, h: 56,  type: 'chip' },
            wagerBotChip:      { x: -240, y: -440, w: 200, h: 56,  type: 'chip' },
