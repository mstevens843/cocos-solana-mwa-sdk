...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    TokenDuelPanel: {
        ...
        elements: {
            ...
            levelPill:       { x: -130, y: 660,  w: 278, h: 54, type: 'chip' },
            solPill:         { x: 170,  y: 660,  w: 195, h: 54, type: 'chip' },
            matchSetupCard:  { x: 0,    y: 455,  w: 712, h: 93, type: 'group' },
            feedFrameCard:   { x: 0,    y: 47,   w: 712, h: 656, type: 'sprite' },
            ...
            feedScrollView:    { x: 0,    y: -16,  w: 696, h: 510, type: 'scrollview' },
            squadPanel:        { x: 0,    y: -401, w: 700, h: 220, type: 'group' },
            squadHeaderLabel:  { x: 0,    y: -336, w: 420, h: 24,  type: 'label' },
            wagerValueButton:  { x: -240, y: -451, w: 200, h: 56,  type: 'btnGhost' },
            wagerStartButton:  { x: 110,  y: -451, w: 460, h: 56,  type: 'btnPrimary' },
            wagerLockChip:     { x: -240, y: -451, w: 200, h: 56,  type: 'chip' },
            wagerBotChip:      { x: -240, y: -451, w: 200, h: 56,  type: 'chip' },
            wagerHintLabel:    { x: 0,    y: -700, w: 600, h: 24,  type: 'label' },
            wagerDropdown:     { x: -240, y: -419, w: 360, h: 360, type: 'group' },
            ...
            status:            { x: 0,    y: -579, w: 688, h: 26,  type: 'label' },
        },
        allowedOverlaps: [
            ['BackLinkLabel', 'BackButton'],
