...
export const LayoutSpec: Record<string, PanelSpec> = {
    ...
    Landing: {
        ...
        elements: {
            ...
            mascot:               { x: 0,   y: 300,  w: 320, h: 320, type: 'mascot' },
            tagline:              { x: 0,   y: 130,  w: 680, h: 40,  type: 'label' },
            supportLine:          { x: 0,   y: 98,   w: 660, h: 22,  type: 'label' },
            ...
            liveSignalLabel:      { x: 0,   y: -114, w: 640, h: 20,  type: 'label' },
    ...
    FindMatchPanel: {
        ...
        elements: {
            ...
            hideFullToggle: { x: 0,    y: 418,  w: 200, h: 28, type: 'btnPrimary' },
